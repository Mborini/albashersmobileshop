...
const Checkout = () => {
  ...
  const sender = async (data, e) => {
    try {
      ...
      const message = `شكراً لتواصلك معنا، تم استلام طلبك بنجاح.\nالاجمالي: ${totalPrice} دينار.\nسنتواصل معك قريباً.`;
      ...
      toast.success("تم إرسال الطلب بنجاح! سنقوم بالتواصل معك على واتساب.");
      ...
      toast.error("حدث خطأ أثناء إرسال الطلب أو رسالة واتساب.");
    }
  };
