        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              <h2 className="font-bold text-black text-3xl lg:text-[45px] lg:leading-[57px] mb-5">
                {t("message1")}
              </h2>
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 mt-5 font-medium text-white bg-black py-3 px-6 rounded-md ease-out duration-200"
              >
