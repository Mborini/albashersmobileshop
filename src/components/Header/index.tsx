  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        ...
        >
          {/* <!-- header top left --> */}
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-start sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0" href="/">
              <Image
                ...
                height={50}
                priority
                className="h-20 xl:h-14 object-contain transition-transform duration-300 hover:scale-105 drop-shadow-md rounded-xl"
              />
            </Link>
          </div>
              ...
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    <BsCartPlus color="#3C50E0" size={20} />
